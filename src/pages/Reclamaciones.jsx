      ...
      <div className="max-w-6xl mx-auto">
        ...
        <div className="text-center mb-8">
          <div className="flex justify-center items-center mb-4">
            ...
            <h1 className="text-4xl font-bold text-red-900">Sistema de Reclamaciones</h1>
          </div>
          <p className="text-gray-600 text-lg">Gestiona tus reclamaciones de forma rápida y eficiente</p>
        </div>
