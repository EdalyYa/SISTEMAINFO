...
import { FaCalendarAlt, FaGraduationCap, FaAward, FaLaptopCode, FaChartLine, FaBuilding, FaRocket, FaCertificate, FaGlobe } from 'react-icons/fa';
  ...
  return (
    <div className="bg-gradient-to-b from-gray-50 to-white">
        ...
        <div className="mx-auto max-w-6xl">
          <div className="relative rounded-3xl bg-blue-50 border border-blue-100 p-6 shadow-sm overflow-hidden">
            ...
            <div className="relative text-center">
              <h1 className="text-3xl md:text-4xl font-bold mb-1 text-gray-900">Nuestra Historia</h1>
              <p className="text-base md:text-xl text-gray-600 max-w-3xl mx-auto">15 años formando líderes tecnológicos</p>
            </div>
          </div>
        </div>
      </div>
      ...
      <div className="max-w-6xl mx-auto px-4 py-4">
          ...
          <div className="bg-white rounded-xl shadow-sm border border-blue-100 p-4">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-3">
              {timelineEvents.map((event) => {
                ...
                return (
                  <div key={event.year} className="bg-white rounded-lg shadow-sm p-3 border border-gray-200 hover:shadow-md transition-shadow duration-300">
          ...
          <div className="space-y-4">
            ...
            <div className="bg-white rounded-xl shadow-sm border border-blue-100 p-5">
              <div className="text-center mb-2">
                <div className="inline-flex items-center justify-center gap-2 mb-1">
                  <span className="inline-block w-2 h-2 rounded-full bg-blue-600" aria-hidden="true"></span>
                  <h2 className="text-2xl font-bold text-gray-900">Contexto Histórico INFOUNA</h2>
                </div>
                <p className="text-gray-600 text-sm">Resumen institucional y desarrollo</p>
              </div>
              <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                <div className="border rounded-lg p-4">
                  <h3 className="text-base font-semibold text-blue-900 mb-1">Fundación y crecimiento</h3>
                  <ul className="list-disc list-inside text-sm text-gray-700 space-y-1">
                    <li>1856: Fundación de la UNA Puno</li>
                    <li>1990: Creación del INFOUNA</li>
                    <li>2010: Modernización de laboratorios</li>
                  </ul>
                </div>
                <div className="border rounded-lg p-4">
                  <h3 className="text-base font-semibold text-blue-900 mb-1">Infraestructura y comunidad</h3>
                  <ul className="list-disc list-inside text-sm text-gray-700 space-y-1">
                    <li>Huawei: conectividad e innovación</li>
                    <li>Docentes y estudiantes comprometidos</li>
                    <li>Impacto regional sostenido</li>
                  </ul>
                </div>
              </div>
            </div>
        ...
        {/* Legado del INFOUNA */}
        <div className="bg-gradient-to-r from-blue-600 to-indigo-600 rounded-xl p-3 text-white text-center mt-4">
