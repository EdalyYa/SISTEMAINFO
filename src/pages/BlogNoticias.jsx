...
import { FaUniversity, FaNewspaper, FaMicrochip } from 'react-icons/fa';
        ...
        {!compact && (
          <div className="relative overflow-hidden rounded-2xl bg-gradient-to-br from-slate-900 via-blue-900 to-slate-800 border border-slate-800 p-6 mb-6 shadow-xl ring-1 ring-blue-300/30">
            ...
            <div className="mt-3 flex flex-wrap gap-2">
              <span className="inline-flex px-2.5 py-1 text-[11px] font-semibold rounded-full bg-emerald-500/90 text-white font-mono tracking-wider">INFO-TECH</span>
            </div>
          </div>
        )}
